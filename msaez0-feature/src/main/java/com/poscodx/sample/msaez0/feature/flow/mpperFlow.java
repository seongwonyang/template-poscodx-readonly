...
path: {{nameCamelCase}}/{{nameCamelCase}}-feature/src/main/java/com/poscodx/sample/{{nameCamelCase}}/feature/flow
fileName: {{namePascalCase}}Flow.java
---
package com.poscodx.sample.{{nameCamelCase}}.feature.flow;
