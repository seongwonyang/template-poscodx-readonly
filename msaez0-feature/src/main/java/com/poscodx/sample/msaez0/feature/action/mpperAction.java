...
path: {{nameCamelCase}}/{{nameCamelCase}}-feature/src/main/java/com/poscodx/sample/{{nameCamelCase}}/feature/action
fileName: {{namePascalCase}}Action.java
---
package com.poscodx.sample.{{nameCamelCase}}.feature.action;
