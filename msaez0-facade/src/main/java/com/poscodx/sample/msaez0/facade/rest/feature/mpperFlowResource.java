...
fileName: mpperFlowResource.java
---
package com.poscodx.sample.{{nameCamelCase}}.facade.rest.feature;

import com.poscodx.sample.{{nameCamelCase}}.feature.flow.mpperFlow;
...
@RestController
@RequestMapping(path = "/mpper-flow")
public class mpperFlowResource {
    private final mpperFlow flow;
