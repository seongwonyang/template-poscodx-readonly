...
path: {{nameCamelCase}}/{{nameCamelCase}}-facade/src/main/java/com/poscodx/sample/{{nameCamelCase}}/facade/rest/feature
fileName: mpperActionResource.java
---
package com.poscodx.sample.{{nameCamelCase}}.facade.rest.feature;

import com.poscodx.sample.{{nameCamelCase}}.feature.action.mpperAction;
...
@RestController
@RequestMapping(path = "/mpper-action")
public class mpperActionResource {
    private final mpperAction action;
